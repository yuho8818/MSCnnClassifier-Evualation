...
class ModelFactory:
    ...
    def get_model(self, class_names, model_name, use_base_weights=True, weights_path=None, input_shape=None,
                  save_weights_only=False):
        if not save_weights_only and weights_path is not None:
